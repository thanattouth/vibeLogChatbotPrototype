...
# แก้ไข HuggingFace tokenizers warning
...
# ใช้ Groq API กับ llama3
llm = ChatGroq(
    model="llama3-70b-8192",
    groq_api_key="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",
    temperature=0.1,
    max_tokens=2048
)
...
# === ฟังก์ชันวิเคราะห์ (ปรับให้เข้ากับ ChatGroq) ===
def analyze_logs(message, logs):
    ...
    # System prompt สำหรับ SOC Analyst
    system_prompt = """
